...
require.register("babel-runtime/helpers/extends.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "babel-runtime");
  (function() {
    "use strict";
...
_router2.default.onReady(function () {
  app.$mount('#app');
});
});
...
var _auth = require('../views/auth.vue');
...
exports.default = new _vueRouter2.default({
  ...
  routes: [{ name: 'auth', path: '/auth', component: _auth2.default }, {
    path: '',
    component: _main2.default,
    children: [{ name: 'home', path: '', component: _home2.default }]
  }, {
    path: '*',
    redirect: '/'
  }]
...
;require.register("store/modules/admin.js", function(exports, require, module) {
"use strict";
...
exports.default = { state: state, getters: getters, actions: actions, mutations: mutations };
});

;require.register("store/modules/auth.js", function(exports, require, module) {
'use strict';
...
var actions = {
  login: function login(_ref, _ref2) {
    ...
    commit('LOGIN_REQUEST', { secret: secret });
  }
};
...
var mutations = {
  ...
  LOGIN_ERROR: function LOGIN_ERROR(state, _ref3) {
...
exports.default = { admin: _admin2.default, workers: _workers2.default, auth: _auth2.default };
});

;require.register("store/modules/workers.js", function(exports, require, module) {
'use strict';
...
var actions = {
  addTask: function addTask(_ref, slug) {
    var commit = _ref.commit;

    commit('ADD_TASK', { slug: slug });
  },
  resumeTask: function resumeTask(_ref2, slug) {
    var commit = _ref2.commit;

    commit('RESUME_TASK', { slug: slug });
  },
  pauseTask: function pauseTask(_ref3, slug) {
    var commit = _ref3.commit;

    commit('PAUSE_TASK', { slug: slug });
  },
  retryRunningTask: function retryRunningTask(_ref4, slug) {
    var commit = _ref4.commit;

    commit('RETRY_RUNNING_TASK', { slug: slug });
  },
  deleteTask: function deleteTask(_ref5, slug) {
    var commit = _ref5.commit;

    commit('DELETE_TASK', { slug: slug });
  }
};

var mutations = {
  SET_HOSTS: function SET_HOSTS(state, _ref6) {
    var hosts = _ref6.hosts;

    state.hosts = hosts || [];
  },
  SET_TASKS: function SET_TASKS(state, _ref7) {
    var tasks = _ref7.tasks;

    state.tasks = tasks || [];
  },
  ADD_TASK: function ADD_TASK(state, _ref8) {
    var slug = _ref8.slug;
  },
  RESUME_TASK: function RESUME_TASK(state, _ref9) {
    var slug = _ref9.slug;
  },
  PAUSE_TASK: function PAUSE_TASK(state, _ref10) {
    var slug = _ref10.slug;
  },
  RETRY_RUNNING_TASK: function RETRY_RUNNING_TASK(state, _ref11) {
    var slug = _ref11.slug;
  },
  DELETE_TASK: function DELETE_TASK(state, _ref12) {
...
exports.default = [_websockets2.default];
});

;require.register("store/plugins/websockets/events.js", function(exports, require, module) {
'use strict';
...
exports.default = function (store, type, data) {
  if (type === 'hosts') {
...
;require.register("store/plugins/websockets/index.js", function(exports, require, module) {
'use strict';
...
exports.default = function (store) {
  ...
  var createInstance = function createInstance(secret) {
    removeInstance();

    var secure = document.location.protocol === 'https:' ? 's' : '';
    instance = (0, _instance2.default)('ws' + secure + '://' + document.location.host + '/admin/' + secret, {
      ...
      onMessage: function onMessage(type, payload) {
        (0, _events2.default)(store, type, payload);
      },
...
;require.register("store/plugins/websockets/instance.js", function(exports, require, module) {
'use strict';
...
var encodeData = function encodeData(data) {
  return unescape(encodeURIComponent((0, _stringify2.default)(data)));
};
...
exports.default = function (wsUrl, _ref) {
  ...
  socket.onmessage = function (event) {
    ...
    var data = decodeData(event.data);
...
;require.register("views/app.vue", function(exports, require, module) {
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-49460cf4", __vue__options__)
  } else {
    hotAPI.reload("data-v-49460cf4", __vue__options__)
  }
})()}
});

;require.register("views/auth.vue", function(exports, require, module) {
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("#auth-page {\r\n  display: flex;\r\n  align-content: center;\r\n  height: 100vh;\r\n  margin: 0;\r\n  padding: 0;\r\n  min-width: 320px;\r\n  overflow: hidden;\r\n  background: #f8f9fa;\r\n  align-items: center;\r\n}\r\n\r\n#auth-page > .empty {\r\n  flex: 1 1 auto;\r\n  max-width: 700px;\r\n  margin: 0 auto;\r\n}")
;(function(){
'use strict';
...
exports.default = {
  ...
  computed: (0, _vuex.mapGetters)(['isConnected', 'authLoading', 'authError']),

  methods: (0, _vuex.mapActions)(['login']),

  watch: {
    isConnected: {
      handler: function handler(isConnected) {
        if (isConnected) {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"auth-page"}},[_c('div',{staticClass:"empty"},[_c('p',{staticClass:"empty-title h5"},[_vm._v("Bot Cluster Administration")]),_vm._v(" "),_c('p',{staticClass:"empty-subtitle"},[_vm._v("Authentication required")]),_vm._v(" "),_c('div',{staticClass:"empty-action"},[(_vm.authError)?_c('p',{staticClass:"toast toast-error"},[_vm._v(_vm._s(_vm.authError))]):_vm._e(),_vm._v(" "),_c('form',{on:{"submit":function($event){$event.preventDefault();_vm.login({ secret: _vm.secret })}}},[_c('div',{staticClass:"form-group"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.secret),expression:"secret"}],staticClass:"form-input text-center",attrs:{"type":"text","placeholder":"Application secret","disabled":!!_vm.authLoading,"required":""},domProps:{"value":(_vm.secret)},on:{"input":function($event){if($event.target.composing){ return; }_vm.secret=$event.target.value}}})]),_vm._v(" "),_c('br'),_vm._v(" "),_c('div',{staticClass:"form-group"},[_c('button',{staticClass:"btn btn-primary",class:{ loading: _vm.authLoading },attrs:{"type":"submit"}},[_vm._v("   Load   ")])])])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1c428a36", __vue__options__)
  } else {
    hotAPI.reload("data-v-1c428a36", __vue__options__)
  }
})()}
});

;require.register("views/home.vue", function(exports, require, module) {
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".tasks .task {\r\n  box-shadow: 0 0.05rem 0.2rem rgba(69,77,93,.3);\r\n}")
;(function(){
'use strict';
...
exports.default = {
  ...
  computed: (0, _extends3.default)({}, (0, _vuex.mapGetters)(['tasks']), {
    aggregatedTasks: function aggregatedTasks() {
      return this.tasks.map(function (task) {
        ...
        var retryPercent = Math.round(task.jobsToRetry * 100 * 100 / task.jobsTotal) / 100;
        var runningPercent = Math.round(task.jobsRunning * 100 * 100 / task.jobsTotal) / 100;
  ...
  methods: (0, _vuex.mapActions)(['addTask', 'resumeTask', 'pauseTask', 'retryRunningTask', 'deleteTask'])
};
})()
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"tasks"},[_c('div',{staticClass:"task rounded bg-gray my-2 p-2"},[_c('form',{on:{"submit":function($event){$event.preventDefault();_vm.addTask(_vm.addTaskSlug)}}},[_c('div',{staticClass:"input-group"},[_c('span',{staticClass:"input-group-addon"},[_vm._v("task-manager/tasks/")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.addTaskSlug),expression:"addTaskSlug"}],staticClass:"form-input",attrs:{"type":"text","placeholder":"Module name"},domProps:{"value":(_vm.addTaskSlug)},on:{"input":function($event){if($event.target.composing){ return; }_vm.addTaskSlug=$event.target.value}}}),_vm._v(" "),_c('button',{staticClass:"btn btn-primary input-group-btn",attrs:{"type":"submit"}},[_vm._v("Add task")])])])]),_vm._v(" "),_vm._l((_vm.aggregatedTasks),function(task){return _c('div',{key:task.slug,staticClass:"task rounded bg-gray my-2 p-2",style:(task.style)},[_c('h5',[_c('span',{staticClass:"label float-right",class:task.statusLabelClass},[_vm._v(_vm._s(task.status))]),_vm._v(" "),_c('span',{staticClass:"mr-2"},[_vm._v(_vm._s(task.moduleName))]),_vm._v(" "),(task.status === 'pause' || task.status === 'canceled')?_c('button',{staticClass:"btn btn-sm btn-primary",on:{"click":function($event){$event.preventDefault();_vm.resumeTask(task.slug)}}},[_vm._v("Resume")]):_vm._e(),_vm._v(" "),(task.status === 'running')?_c('button',{staticClass:"btn btn-sm btn-secondary",on:{"click":function($event){$event.preventDefault();_vm.pauseTask(task.slug)}}},[_vm._v("Pause")]):_vm._e(),_vm._v(" "),(task.status === 'running')?_c('button',{staticClass:"btn btn-sm btn-secondary",on:{"click":function($event){$event.preventDefault();_vm.retryRunningTask(task.slug)}}},[_vm._v("Retry running")]):_vm._e(),_vm._v(" "),_c('button',{staticClass:"btn btn-sm btn-error",on:{"click":function($event){$event.preventDefault();_vm.deleteTask(task.slug)}}},[_vm._v(_vm._s(task.status === 'canceled' ? 'Delete' : 'Cancel'))])]),_vm._v(" "),_c('pre',{staticClass:"code",attrs:{"data-lang":((task.slug) + " (" + (task.jobsDone) + "/" + (task.jobsTotal) + ")")}},[_c('code',[_vm._v(_vm._s(task.result || 'N/A'))])]),_vm._v(" "),_c('div',{staticClass:"bar"},[_c('div',{staticClass:"bar-item tooltip tooltip-right",style:({ width: task.donePercent + '%', background: '#32B63E' }),attrs:{"data-tooltip":("Done: " + (task.jobsDone) + " (" + (task.donePercent) + "%)")}}),_vm._v(" "),_c('div',{staticClass:"bar-item tooltip tooltip-right",style:({ width: task.retryPercentDisplay + '%', background: '#e85600' }),attrs:{"data-tooltip":("To retry: " + (task.jobsToRetry) + " (" + (task.retryPercent) + "%)")}}),_vm._v(" "),_c('div',{staticClass:"bar-item tooltip tooltip-right",style:({ width: task.runningPercentDisplay + '%' }),attrs:{"data-tooltip":("Running: " + (task.jobsRunning) + " (" + (task.runningPercent) + "%)")}})])])})],2)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7f855e9c", __vue__options__)
  } else {
    hotAPI.reload("data-v-7f855e9c", __vue__options__)
  }
})()}
});

;require.register("views/main.vue", function(exports, require, module) {
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".hosts {\r\n  columns: 10em;\r\n  column-gap: 1em;\r\n}\r\n.hosts > div {\r\n  width: 100%;\r\n  -webkit-column-break-inside: avoid;\r\n  page-break-inside: avoid;\r\n  break-inside: avoid;\r\n}")
;(function(){
'use strict';
...
exports.default = {
  ...
  computed: (0, _extends3.default)({}, (0, _vuex.mapGetters)(['isConnected', 'hosts']), {
    sortedHosts: function sortedHosts() {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('div',{staticClass:"columns"},[_c('div',{staticClass:"column col-7"},[_c('router-view')],1),_vm._v(" "),_c('div',{staticClass:"column col-5"},[_c('div',{staticClass:"menu hosts"},_vm._l((_vm.sortedHosts),function(host,$index){return _c('div',{key:$index},[_c('h6',{staticClass:"text-center"},[_c('small',[_vm._v(_vm._s(host.name || ("worker-" + $index)))])]),_vm._v(" "),_vm._l((host.workers),function(worker,$indexWorker){return _c('div',{key:'worker-' + $index + '-' + $indexWorker,staticClass:"bar bar-sm my-1"},[_c('div',{staticClass:"bar-item",style:({ width: (worker || 0) + '%' }),attrs:{"role":"progressbar","aria-valuenow":worker || 0,"aria-valuemin":"0","aria-valuemax":"100"}})])})],2)}))])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c8011b14", __vue__options__)
  } else {
    hotAPI.reload("data-v-c8011b14", __vue__options__)
  }
})()}
});
